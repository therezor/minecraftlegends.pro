...
>
    @foreach (array_slice($getTags(), 0, $getLimit()) as $tag)
        <span
            @class([
                'min-h-6 inline-flex items-center justify-center whitespace-normal rounded bg-primary-500/10 px-2 py-0.5 text-sm font-medium tracking-tight text-primary-700',
