                            ...
                            >
                                <label>
                                    ...
                                    <select
                                        ...
                                        @class([
                                            'text-xs pl-2 pr-6 py-1 font-medium border-0 bg-gray-500/5 rounded border-gray-300 sm:text-sm focus:ring-0 focus:border-primary-500 focus:ring-primary-500',
