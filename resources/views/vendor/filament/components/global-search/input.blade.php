<div {{ $attributes->class(['filament-global-search-input']) }}>
    ...
    <div class="relative group max-w-md">
        ...
        <input
            ...
            autocomplete="off"
            @class([
                'block w-full h-10 pl-10 bg-gray-400/10 placeholder-gray-500 border-transparent transition duration-75 rounded outline-none focus:bg-white focus:placeholder-gray-400 focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500',
