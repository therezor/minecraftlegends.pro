    ...
    >
        @unless ($isDisabled())
            ...
            <trix-editor
                ...
                {{ $getExtraInputAttributeBag()->class([
                    'bg-white block w-full transition duration-75 rounded shadow-sm outline-none focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500 prose max-w-none break-words',
        ...
        @else
            <div x-html="state" @class([
                'prose block w-full max-w-none rounded border border-gray-300 bg-white p-3 opacity-70 shadow-sm',
