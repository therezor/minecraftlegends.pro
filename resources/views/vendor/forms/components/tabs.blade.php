<div
    ...
    {{ $attributes->merge($getExtraAttributes())->class([
        'filament-forms-tabs-component rounded shadow-sm border border-gray-300 bg-white',
        ...
        @foreach ($getChildComponentContainer()->getComponents() as $tab)
            ...
            >
                ...
                @if ($badge = $tab->getBadge())
                    <span
                        class="inline-flex items-center justify-center ml-auto rtl:ml-0 rtl:mr-auto min-h-4 px-2 py-0.5 text-xs font-medium tracking-tight rounded whitespace-normal"
                        x-bind:class="{
