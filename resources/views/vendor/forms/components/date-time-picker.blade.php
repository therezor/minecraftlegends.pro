    ...
    >
        ...
        <button
            ...
            {{ $getExtraTriggerAttributeBag()->class([
                'bg-white relative w-full border py-2 pl-3 pr-10 rtl:pl-10 rtl:pr-3 text-start cursor-default rounded shadow-sm outline-none',
        ...
        <div
            ...
            @class([
                'absolute hidden z-10 my-1 bg-white border border-gray-300 rounded shadow-md',
        ...
        >
            <div class="space-y-3">
                ...
                @if ($hasTime())
                    <div
                        @class([
                            'flex items-center justify-center bg-gray-50 py-2 rounded rtl:flex-row-reverse',
