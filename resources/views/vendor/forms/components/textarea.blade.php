    ...
    <textarea
        ...
        {{
            $attributes
                ...
                ->class([
                    'filament-forms-textarea-component block w-full transition duration-75 rounded shadow-sm outline-none focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500 disabled:opacity-70',
