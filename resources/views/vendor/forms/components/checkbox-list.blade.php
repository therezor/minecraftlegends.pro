        ...
        @if (! $isDisabled())
            @if ($isSearchable())
                <input
                    ...
                    @class([
                        'mb-2 block h-7 px-2 text-sm w-full rounded border-gray-300 shadow-sm text-gray-700 transition duration-75 outline-none focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500',
