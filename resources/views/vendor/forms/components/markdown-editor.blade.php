...
>
    ...
    >
        <div class="space-y-2">
            ...
            <div x-show="tab === 'edit'" class="relative w-full h-full" style="min-height: 150px;">
                <file-attachment directory>
                    <textarea
                        ...
                        @endif
                        class="tracking-normal overflow-y-hidden font-mono block absolute bg-transparent top-0 text-sm left-0 z-1 w-full h-full min-h-full resize-none transition duration-75 rounded shadow-sm outline-none focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500 caret-black whitespace-pre-wrap rtl:whitespace-normal"
                        x-bind:class="{
                ...
                <div
                    ...
                    @class([
                        'w-full h-full rounded px-3 py-2 border border-transparent font-mono tracking-normal bg-white text-sm text-gray-900 break-words whitespace-pre-wrap rtl:whitespace-normal',
            ...
            <div @class([
                'prose max-w-none block w-full h-full min-h-full px-3 py-2 bg-white border border-gray-300 rounded shadow-sm break-words focus:border-primary-300',
