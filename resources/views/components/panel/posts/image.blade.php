...
@else
    <div wire:loading.class="pe-none" wire:target="{{ $inputName }}" class="rounded bg-secondary bg-opacity-10 bg-opacity-20-hover border border-secondary position-relative">
