...
>
    @php
        ...
        $blocks = array_filter($getBlocks(), fn ($component) => ! $component->isDisabled());
    @endphp
    ...
    <div {{ $attributes->merge($getExtraAttributes())->class([
        'filament-forms-builder-component space-y-6 rounded',
            ...
            >
                ...
                @foreach ($containers as $uuid => $item)
                    <li
                        ...
                        "
                        @class([
                            'bg-white border border-gray-300 shadow-sm rounded relative',
                        ...
                        @if ((! $isItemMovementDisabled) || $hasBlockLabels || (! $isItemDeletionDisabled) || $isCollapsible || $isCloneable)
                            ...
                            >
                                ...
                                <ul @class([
                                    ...
                                    @unless ($isItemDeletionDisabled || $block->isDisabled())
                                        <li>
                                            <button
