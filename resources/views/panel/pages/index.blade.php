...
@section('container')
    <div class="row push row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        <div class="col">
            <a class="block block-rounded block-link-pop text-center mb-0 h-100" href="{{ route('panel.create') }}">
        ...
        @foreach($sites as $site)
            <div class="col">
                <a class="block block-rounded block-link-pop text-center mb-0 h-100" href="{{ route('panel.show', $site->sub_domain) }}">
