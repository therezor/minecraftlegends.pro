        ...
        <div class="d-flex align-items-center">
            @guest
                <div class="dropdown d-lg-none ms-2">
                    <button type="button" class="btn btn-sm btn-alt-secondary d-lg-none" data-bs-toggle="dropdown"
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0"
                        ...
                        <div class="p-2">
                            <a href="{{ route('register') }}"
                               class="btn btn-sm btn-primary d-block mb-2">{{ __('Register') }}</a>
                ...
                <a class="btn btn-sm btn-outline-primary ms-2 d-none d-lg-inline-block"
                   href="{{ route('login') }}">{{ __('Log in') }}</a>
                <a href="{{ route('register') }}"
                   class="btn btn-sm btn-primary ms-2 d-none d-lg-inline-block">{{ __('Register') }}</a>
            @else
