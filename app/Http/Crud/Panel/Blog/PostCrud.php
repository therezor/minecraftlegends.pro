...
namespace App\Http\Crud\Panel\Blog;
...
use App\Forms\Panel\Blog\Post\{Form, FilterForm};
...
class PostCrud extends BaseCrud
{
    ...
    {
        return trans('panel.blog.posts.title');
    }

    public function getRouteName(): string
    {
        return 'panel.blog-posts';
    }
    ...
    public function getViewByMethod(Method $method): string
    {
        if (Method::CREATE === $method) {
            return 'panel.blog.posts.create';
        }

        if (Method::EDIT === $method) {
            return 'panel.blog.posts.edit';
        }

        if (Method::SHOW === $method) {
            return 'panel.blog.posts.show';
        }
