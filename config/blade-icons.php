    ...
    */
    ...
    'sets' => [
        'default' => [
            ...
            'paths' => [
                'resources/icons/outline/arrows',
                'resources/icons/outline/e-commerce',
                'resources/icons/outline/emoji',
                'resources/icons/outline/file-folders',
                'resources/icons/outline/general',
                'resources/icons/outline/media',
                'resources/icons/outline/text',
                'resources/icons/outline/user',
                'resources/icons/outline/weather',
            ],
        ],
        ...
        'simple-icons' => [
            ...
            'paths' => [
                'vendor/ublabs/blade-simple-icons/resources/svg',
            ],
        ],
